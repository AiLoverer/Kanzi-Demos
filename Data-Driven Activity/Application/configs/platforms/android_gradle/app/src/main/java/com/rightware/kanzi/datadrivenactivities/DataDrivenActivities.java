package com.rightware.kanzi.datadrivenactivities;
...
public class DataDrivenActivities extends FragmentActivity
{
    private static final String TAG = "DataDrivenActivities";
