package com.rightware.kanzi.activitytransitions;
...
public class ActivityTransitions extends FragmentActivity
{
    private static final String TAG = "ActivityTransitions";
